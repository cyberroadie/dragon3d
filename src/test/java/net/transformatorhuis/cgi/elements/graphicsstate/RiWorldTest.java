 ...
 * @version 1.0
 */
public class RiWorldTest extends GeneralRibTest {

    private static Logger logger = Logger.getLogger(RiWorldTest.class);

    private String testRISpecRIBFragment = "WorldBegin";

    private String testRISpecXMLFragment = "<world></world>";
