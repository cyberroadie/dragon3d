...
public interface Node {
	...
	/** The node is an ATTLIST */
	static short ATTLIST_NODE = 0;
	/** The node is an ELEMENT */
	static short ELEMENT_NODE = 1;
	/** The node is an ENTITY */
	static short ENTITY_NODE = 2;
	/** The node is an comment */
	static short COMMENT_NODE = 3;
